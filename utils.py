...
def parse_args():
    ...
    parser.add_argument('--warmup_lr', type=float, default=0.1, help='warm up learning rate ratio.')
    parser.add_argument('--warmup_epochs', type=float, default=0.1, help='warm up epochs.')
    ...
    # Optimization
    parser.add_argument('--optimizer', type=str, default='Adam', help='the type of the optimizer.')
    parser.add_argument('--learning_rate', type=float, default=5e-5, help='the learning rate for the visual extractor.')
    parser.add_argument('--mul_head', type=float, default=10, help='the learning rate for the visual extractor.')
    ...
    parser.add_argument('--max_grad_norm', type=float, default=1, help='the value for clip grad')
    ...
    parser.add_argument('--print_freq', type=int, default=50, help='the number of layers for text encoder')
