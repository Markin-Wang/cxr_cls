...
def build_scheduler(args, optimizer, n_iter_per_epoch):
    ...
    #decay_epochs = [int(item) for item in args.decay_epochs.split(',')]
    # decay_epochs = args.decay_epochs
    # decay_steps = int(decay_epochs[0] * n_iter_per_epoch)

    # multi_steps = [i * n_iter_per_epoch for i in decay_epochs]
    ...
    if args.lr_scheduler == 'cosine':
        ...
        lr_scheduler = LinearLRScheduler(
            optimizer,
            t_initial=num_steps,
            lr_min_rate=args.warmup_lr/1e2,
            warmup_lr_init=args.warmup_lr,
            warmup_t=warmup_steps,
            t_in_epochs=False,
        )
