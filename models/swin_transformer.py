...
default_cfgs = {
    ...
    'swin_small_patch4_window7_224': _cfg(
        ...
        input_size=(3, 224, 244), crop_pct=1.0),
    ...
    'swin_tiny_patch4_window7_224_in22k': _cfg(
        url='https://github.com/SwinTransformer/storage/releases/download/v1.0.8/swin_tiny_patch4_window7_224_22k.pth',
        input_size=(3, 224, 224), crop_pct=1.0, num_classes=21841),

    'swin_small_patch4_window7_224_in22k': _cfg(
...
def swin_small_patch4_window7_224_in22k(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dim=96, depths=(2, 2, 18, 2), num_heads=(3, 6, 12, 24), **kwargs)
    return _create_swin_transformer('swin_small_patch4_window7_224_in22k', pretrained=pretrained, **model_kwargs)
...
def swin_tiny_patch4_window7_224_in22k(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dim=96, depths=(2, 2, 6, 2), num_heads=(3, 6, 12, 24), **kwargs)
    return _create_swin_transformer('swin_tiny_patch4_window7_224_in22k', pretrained=pretrained, **model_kwargs)
